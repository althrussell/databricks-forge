...
function PromptVersionsCard({
  ...
  // Cache fetched template text to avoid re-fetching
              ...
              <Collapsible key={key}>
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {isRemoved && (
                      <span className="text-[10px] text-amber-600">removed</span>
                    )}
                    <ChevronDown className="h-3.5 w-3.5 text-muted-foreground" />
                  </div>
                </CollapsibleTrigger>
                <CollapsibleContent>
                  <div className="border border-t-0 border-amber-300 rounded-b-md px-3 py-3 dark:border-amber-800">
                    {loadingDiff === key && (
                        ...
                        <div>
                          ...
                          {cached.run ? (
                            ...
                            <p className="text-xs italic text-muted-foreground">
                              Template not in archive (run predates prompt versioning)
                            </p>
                          )}
                        </div>
                        <div>
